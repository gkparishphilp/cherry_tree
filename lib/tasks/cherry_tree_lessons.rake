task :cherry_tree_lessons => :environment do
	...
	s1 = l.screens.create :sequence => 1, :content => "<h1>Roman Numerals</h1><p>Roman numerals are letters of the alphabet that represent numbers.</p><ul><li>I = 1</li><li>V = 5</li><li>X = 10</li><li>L = 50</li><li>C = 100</li><li>D = 500</li><li>M = 1000</li></ul><img src='/images/rn1.png' width=150 alt='The Roman Coliseum.'/>"  
	s2 = l.screens.create :sequence => 2, :content => "<h1>The History of Roman Numerals</h1><p>The Roman numerals system dates back over 2,000 years to ancient Rome. Today we usually use Arabic numbers, but you can still see Roman numerals in tables of contents, on some clocks and watches, or as a suffix on a person's name.</p><p>John Smith III</p><img src='/images/rn2.png' width=150 alt='An old fashioned clock face.'/>"  
	...
	quest10.answers.create :content => 'MCI'
	quest10.answers.create :content => 'MDI', :correct => true
	...
	quest5.answers.create :content => "<img src='/images/impq51.png' width=150 alt='Choice A'/>", :correct => true
	quest5.answers.create :content => "<img src='/images/impq52.png' width=150 alt='Choice B'/>"
	quest5.answers.create :content => "<img src='/images/impq53.png' width=150 alt='Choice C'/>"
	quest5.answers.create :content => "<img src='/images/impq54.png' width=150 alt='Choice D'/>"
	quest6 = q.questions.create :content => 'Which painting was most likely painted "en plein air"?'
	quest6.answers.create :content => "<img src='/images/impq61.png' width=150 alt='Choice A'/>", :correct => true
	quest6.answers.create :content => "<img src='/images/impq62.png' width=150 alt='Choice B'/>"
	quest6.answers.create :content => "<img src='/images/impq63.png' width=150 alt='Choice C'/>"
	quest6.answers.create :content => "<img src='/images/impq64.png' width=150 alt='Choice D'/>"
	quest7 = q.questions.create :content => 'Which painting does NOT look like a Claude Monet painting?'
	quest7.answers.create :content => "<img src='/images/impq71.png' width=150 alt='Choice A'/>"
	quest7.answers.create :content => "<img src='/images/impq72.png' width=150 alt='Choice B'/>"
	quest7.answers.create :content => "<img src='/images/impq73.png' width=150 alt='Choice C'/>", :correct => true
	quest7.answers.create :content => "<img src='/images/impq74.png' width=150 alt='Choice D'/>"
	quest8 = q.questions.create :content => 'Which painting does NOT look like an Edgar Degas painting?'
	quest8.answers.create :content => "<img src='/images/impq81.png' width=150 alt='Choice A'/>"
	quest8.answers.create :content => "<img src='/images/impq82.png' width=150 alt='Choice B'/>", :correct => true
	quest8.answers.create :content => "<img src='/images/impq83.png' width=150 alt='Choice C'/>"
	quest8.answers.create :content => "<img src='/images/impq84.png' width=150 alt='Choice D'/>"
	quest9 = q.questions.create :content => 'Which painting does NOT look like a Mary Cassatt painting?'
	quest9.answers.create :content => "<img src='/images/impq91.png' width=150 alt='Choice A'/>", :correct => true
	quest9.answers.create :content => "<img src='/images/impq92.png' width=150 alt='Choice B'/>"
	quest9.answers.create :content => "<img src='/images/impq93.png' width=150 alt='Choice C'/>"
	quest9.answers.create :content => "<img src='/images/impq94.png' width=150 alt='Choice D'/>"
	quest10 = q.questions.create :content => 'Which of these Impressionist paintings do you like best?  HINT: There is no wrong answer!'
	quest10.answers.create :content => "<img src='/images/impq101.png' width=150 alt='Choice A'/>", :correct => true
	quest10.answers.create :content => "<img src='/images/impq102.png' width=150 alt='Choice B'/>", :correct => true
	quest10.answers.create :content => "<img src='/images/impq103.png' width=150 alt='Choice C'/>", :correct => true
	quest10.answers.create :content => "<img src='/images/impq104.png' width=150 alt='Choice D'/>", :correct => true
	...
	quest = q.questions.create :content => '<img src="/images/comm1.png" width=150 alt="Talking to someone"/><p>What should you do when talking to someone?<p>'
	...
	quest2 = q.questions.create :content => '<img src="/images/comm2.png" width=150 alt="I will not interrupt them."/><p>Why is it wrong to interrupt someone who is speaking to you?</p>'
	...
	quest3 = q.questions.create :content => '<img src="/images/comm3.png" width=150 alt="Emotional Megaphone!"/><p>What should you NOT do when having a conversation?</p>'
	...
	quest4 = q.questions.create :content => '<img src="/images/comm4.png" width=150 alt="Leapfrog"/><p>When someone is talking to you about a specific topic...</p>'
	...
	quest5 = q.questions.create :content => '<img src="/images/comm5.png" width=150 alt="Good conversation."/><p>How should you look when having a conversation with someone?</p>'
	...
	quest6 = q.questions.create :content => '<img src="/images/comm6.png" width=150 alt="Phone call during dinner."/><p>If someone close to you calls you in the middle of dinner, what should you tell the caller?</p>'
	...
	quest7 = q.questions.create :content => '<img src="/images/comm7.png" width=150 alt="Ants cutting in line..."/><p>Someone cuts in front of you in a line. You:</p>'
	...
	quest8 = q.questions.create :content => '<img src="/images/comm8.png" width=150 alt="Cartoon yelling..."/><p>If you get into an argument, you should:</p>'
	...
	quest9 = q.questions.create :content => '<img src="/images/comm9.png" width=150 alt="teasing"/><p>If someone is making fun of you, you should:</p>'
	...
	quest10 = q.questions.create :content => '<img src="/images/comm10.png" width=150 alt="Running late"/><p>Your mom is making you late to practice. You should:</p>'
	...
	quest = q.questions.create :content => '<img src="/images/emo1.png" width=150 alt="Face 1"/><p>This face is expressing...<p>'
	...
	quest2 = q.questions.create :content => '<img src="/images/emo2.png" width=150 alt="Face 2"/><p>This face is expressing...<p>'
	...
	quest3 = q.questions.create :content => '<img src="/images/emo3.png" width=150 alt="Face 3"/><p>This face is expressing...<p>'
	...
	quest4 = q.questions.create :content => '<img src="/images/emo4.png" width=150 alt="Face 4"/><p>This face is expressing...<p>'
	...
	quest5 = q.questions.create :content => '<img src="/images/emo5.png" width=150 alt="Face 5"/><p>This face is expressing...<p>'
	...
	quest6 = q.questions.create :content => '<img src="/images/emo6.png" width=150 alt="Face 6"/><p>This face is expressing...<p>'
	...
	quest7 = q.questions.create :content => '<img src="/images/emo7.png" width=150 alt="Face 7"/><p>This face is expressing...<p>'
	...
	quest8 = q.questions.create :content => '<img src="/images/emo8.png" width=150 alt="Face 8"/><p>This face is expressing...<p>'
	...
	quest9 = q.questions.create :content => '<img src="/images/emo9.png" width=150 alt="Face 9"/><p>This face is expressing...<p>'
	...
	quest10 = q.questions.create :content => '<img src="/images/emo10.png" width=150 alt="Face 10"/><p>This face is expressing...<p>'
	...
	quest = q.questions.create :content => '<img src="/images/fr1.png" width=150 alt="Lunchbox"/><p>When you sit down at lunch with your friend, what should you do?<p>'
	...
	quest2 = q.questions.create :content => '<img src="/images/fr2.png" width=150 alt="Teasing"/><p>Someone is making fun of your best friend. What should you do?<p>'
	...
	quest3 = q.questions.create :content => '<img src="/images/fr3.png" width=150 alt="Standing in line"/><p>You really wanted to be line leader today but your friend is chosen instead. What should you do?<p>'
	...
	quest4 = q.questions.create :content => '<img src="/images/fr4.png" width=150 alt="Show and tell"/><p>You tell your friend that you are going to bring a Barbie doll to show &amp; tell. Next thing you know she brings the same Barbie doll to show & tell. What should you do?<p>'
	...
	quest5 = q.questions.create :content => "<img src='/images/fr5.png' width=150 alt='Hurt my arm'/><p>You hurt your arm, and your friend didn't ask you if you were ok. The next day she hurts her arm. What should you do?<p>"
	...
	quest6 = q.questions.create :content => '<img src="/images/fr6.png" width=150 alt="Basketball hoop"/><p>You and PJ made plans to play at the park. Then Brian calls and invites you to come over and play basketball. You love basketball. What should you do?<p>'
	...
	quest7 = q.questions.create :content => '<img src="/images/fr7.png" width=150 alt="Juggling Clown"/><p>You are having a birthday party and you want to have a clown there. Your friend Sara is scared of clowns. What should you do?<p>'
	...
	quest8 = q.questions.create :content => "<img src='/images/fr8.png' width=150 alt='Playing with toy truck'/><p>Your friend borrows your toy. When he brings it back, he doesn't tell you that one of the wheels is broken. What should you do?<p>"
	...
	quest9 = q.questions.create :content => '<img src="/images/fr9.png" width=150 alt="Babies"/><p>You see your friend crying. What should you do?<p>'
	...
	quest10 = q.questions.create :content => "<img src='/images/fr10.png' width=150 alt='Birthday!'/><p>It's your best friend's birthday and you forgot. What should you do?:<p>"
	...
	quest = q.questions.create :content => "<img src='/images/sc1.png' width=150 alt='Bag over head'/><p>You do something embarrassing in front of your class, how do you behave afterwards?<p>"
	...
	quest2 = q.questions.create :content => "<img src='/images/sc2.png' width=150 alt='Distracted'/><p>You get distracted and drop your books on the ground, what's your first reaction?<p>"
	...
	quest3 = q.questions.create :content => '<img src="/images/sc3.png" width=150 alt="Spilled drink"/><p>Your brother runs into you and spills your drink on your shirt, what do you do?<p>'
	...
	quest4 = q.questions.create :content => "<img src='/images/sc4.png' width=150 alt='Soccer game'/><p>You're playing Soccer and someone accidentally trips you, what do you do?<p>"
	...
	quest5 = q.questions.create :content => '<img src="/images/sc5.png" width=150 alt="Disagreement"/><p>When you disagree with someone, you should:<p>'
	...
	quest6 = q.questions.create :content => '<img src="/images/sc6.png" width=150 alt="Broken toy"/><p>You come home and find your toy is broken, what should you do?<p>'
	...
	quest7 = q.questions.create :content => '<img src="/images/sc7.png" width=150 alt="Teasing"/><p>If someone is making fun of you, you should:<p>'
	...
	quest8 = q.questions.create :content => '<img src="/images/sc8.png" width=150 alt="Ants cut in line"/><p>Someone cuts in front of you in a line. You:<p>'
	...
	quest9 = q.questions.create :content => '<img src="/images/sc9.png" width=150 alt="Friend falls over"/><p>Your friend falls and is badly hurt. What should you do?<p>'
	...
	quest10 = q.questions.create :content => '<img src="/images/sc10.png" width=150 alt="Mom running around"/><p>Your mom is making you late to practice. You should:<p>'
	quest10.answers.create :content => "Ask her if you can help her with something so that you can get to practice on time.", :correct => true
	...
	s1 = l.screens.create :sequence => 1, :content => "<h1>Patience</h1><p>Patience is showing a positive reaction even in a difficult circumstance. To be patient, you must first think before you act. This gives you time to settle things out in an orderly manner.</p><p>There are many benefits to being patient.  It will make you into a friendly and successful person, allow you to avoid feelings of frustration, and help you cope when things don't go as you plan.</p><p>Patience also helps manage anger. When you are patient, you will be able to control your feeling of disappointment, embarrassment and hatred. You will be able to turn those situations into positive ones.</p>"  


	# Patience Lesson
	q = l.quizzes.create :name => 'Patience', :point_value => 10
	quest = q.questions.create :content => "<img src='/images/p1.png' width=150 alt='Spilled glass'/><p>While having a meal, your brother or sister accidentally spills something over you. Which of these should you NOT do?<p>"
	...
	quest2 = q.questions.create :content => "<img src='/images/p2.png' width=150 alt='Talks too much'/><p>Your teacher asks you to do a project with another student that you think talks too much. Which of these should you NOT do?<p>"
	...
	quest3 = q.questions.create :content => "<img src='/images/p3.png' width=150 alt='Remote'/><p>Your grandpa can't figure out how to use the remote to turn the TV on. You should...<p>"
	...
	quest4 = q.questions.create :content => "<img src='/images/p4.png' width=150 alt='Karate'/><p>You have karate practice, but when it is time to go your mom isn't ready. You should...<p>"
	...
	quest5 = q.questions.create :content => "<img src='/images/p5.png' width=150 alt='TV'/><p>Your favorite TV show freezes right in the middle of watching it. Which of these should you NOT do?<p>"
	...
	quest6 = q.questions.create :content => "<img src='/images/p6.png' width=150 alt='Bored'/><p>You finished your work and your desk is clear, but someone in your group has not and your teacher won't dismiss your group for recess until everyone is done.<p>"
	...
	quest7 = q.questions.create :content => "<img src='/images/p7.png' width=150 alt='Waiting In line'/><p>You've been waiting for a while to play with a toy, but the person playing with it is not giving you a turn. What should you do?<p>"
	...
	quest8 = q.questions.create :content => "<img src='/images/p8.png' width=150 alt='Talking on the phone'/><p>You want to tell your mother something but she is on the phone. You should?<p>"
	...
	quest9 = q.questions.create :content => "<img src='/images/p9.png' width=150 alt='Baby sucking on toy'/><p>If you find your baby brother sucking on your toy, you should<p>"
	...
	quest10 = q.questions.create :content => "<img src='/images/p10.png' width=150 alt='Playing goalie'/><p>You really want to play goalie in your soccer game and the coach told you that you would get the chance at your next game. But when your next game came up, he didn't put you at goalie.  You should:<p>"
	...
	s2 = l.screens.create :sequence => 2, :content => "<h1>Groovy Warm Up</h1><p>Dance to your favorite song.  If you can't play it right now, sing it while you dance.</p><img src='/images/ec1.png' width=150 alt='Dance'/>"  
	s3= l.screens.create :sequence => 3, :content => "<h1>Upper Body Stretch</h1><p>Stretch your right arm across your body and count to 20.</p><p>Stretch your left arm across your body and count to 20.</p><img src='/images/ec2.png' width=150 alt='Stretch arms'/>"  
	s4 = l.screens.create :sequence => 4, :content => "<h1>Lower Body Stretch</h1><p>Sit on the ground with your legs in a straddle.  Reach for your right foot and count to 20.</p><p>Reach for your left foot and count to 20.</p><p>Reach for the middle and count to 20.</p><img src='/images/ec3.png' width=150 alt='Stretch legs'/>"  
	s5 = l.screens.create :sequence => 5, :content => "<h1>Butterfly Yoga Pose</h1><p>Sit on the floor with your knees bent and the bottoms of your feet together.  Grab your feet, push your knees to the ground and sit up nice and straight.  Breathe in and out slowly while you feel the stretch in your legs and back.</p><img src='/images/ec4.png' width=150 alt='Stretch Back'/>"  
	s6 = l.screens.create :sequence => 6, :content => "<h1>Bow Yoga Pose</h1><p>Lie on your tummy.  Bend your knees and grab your ankles behind you.  Take a deep breath in while you lift your head and chest and legs off of the floor.  Feel the stretch in your back and tummy.  When you are ready, breathe out and lie back down slowly.</p><img src='/images/ec5.png' width=150 alt='Bow yoga'/>"  
	s7 = l.screens.create :sequence => 7, :content => "<h1>Heart Workout</h1><p>Pick an activity that will get your heart rate going, and do it for at least 5 minutes.  You could  jog, skip, jump rope, do jumping jacks, dance around, or ride your bike or scooter.</p><img src='/images/ec6.png' width=150 alt='Heart rate activity'/>"  
	s8 = l.screens.create :sequence => 8, :content => "<h1>Squat Jumps</h1><p>Start in a squat with your hands on the ground.  From the squat position, jump as high as you can with your hands over your head.  Do this 10 times.</p><img src='/images/ec7-1.png' width=150 alt='Squat'/><img src='/images/ec7-2.png' width=150 alt='Jump'/>"  
	s9 = l.screens.create :sequence => 9, :content => "<h1>Push Ups</h1><p>Start in a push up position, facing down with your hands and toes on the ground, and your back nice and straight.  Complete 10 push ups.</p><img src='/images/ec8.png' width=150 alt='Pushups'/>"  
	...
	s2 = l.screens.create :sequence => 2, :content => "<h1>Stand Tall</h1><p>Reach your hands as high as you can and stand on your tippy toes while you count to 10.</p><img src='/images/ms1.png' width=150 alt='Stand tall!'/>"  
	s3= l.screens.create :sequence => 3, :content => "<h1>Toe Touch</h1><p>Stand with your legs straight and reach for your toes while you count to 10.</p><img src='/images/ms2.png' width=150 alt='Toe touch'/>"  
	s4 = l.screens.create :sequence => 4, :content => "<h1>Bunny Jumps</h1><p>Jump up and down 10 times.</p><p>Reach for the middle and count to 20.</p><img src='/images/ms3.png' width=150 alt='Bunny Jumps'/>"  
	s5 = l.screens.create :sequence => 5, :content => "<h1>Straddle Sits</h1><p>Sit on the ground with your legs apart in a straddle.  Reach forward and count to 10.</p><img src='/images/ms4.png' width=150 alt='Straddle Sit'/>"  
	s6 = l.screens.create :sequence => 6, :content => "<h1>Make a Table</h1><p>Sit on the floor with your knees tucked in front of you and hands behind you.  Push your tummy up to make a table.</p><img src='/images/ms5.png' width=150 alt='Make a table'/>"  
	s7 = l.screens.create :sequence => 7, :content => "<h1>Palm Push</h1><p>Stand with the palms of your hands together.  Push your palms together as hard as you can while you count to 10.</p><img src='/images/ms6.png' width=150 alt='Palm Push'/>"  
	s8 = l.screens.create :sequence => 8, :content => "<h1>Lazy 8's</h1><p>A Lazy 8 is the number 8 on its side.  Use your right hand to draw 5 Lazy 8's in the air in front of you.  Then use your left hand to draw 5 Lazy 8's in the air in front of you.</p><img src='/images/ms7.png' width=150 alt='Lazy 8s'/>"  
